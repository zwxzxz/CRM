 ...
 * @author mqxu
 */
public class SourceCategoryController implements Initializable {
    /**
     * 获得布局文件中的表格对象
     */
    @FXML
    private TableView<SourceCategory> sourcecategoryTable;

    /**
     * 定义ObservableList数据集合
     */
    private final ObservableList<SourceCategory> sourcecategoryData = FXCollections.observableArrayList();
    ...
    private final TableColumn<SourceCategory, SourceCategory> delCol = new TableColumn<>("操作");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        delCol.setCellFactory(param -> new TableCell<>() {
            ...
            @Override
            protected void updateItem(SourceCategory sourcecategory, boolean empty) {
